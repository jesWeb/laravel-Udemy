                ...
                <form>
                    <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <input class="w-full mt-2 rounded-md form-input focus:border-indigo-600" type="email">
                        </div>
                    ...
                    <div class="flex justify-end mt-4">
                        <button class="px-4 py-2 text-gray-200 bg-gray-800 rounded-md hover:bg-gray-700 focus:outline-none focus:bg-gray-700">Save</button>
                    </div>
                </form>
            </div>
        </div>
